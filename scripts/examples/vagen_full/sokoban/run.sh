...
# Set ROCm visible devices (adjust based on available GPUs)
...
export WANDB_API_KEY=4024c1f564d91eef1caf2bd92ed990509f8345f2
...
# Extract the last 3 parts of the model path for wandb name
MODEL_PATH=ssmmzz/Qwen2.5-VL-3B-IL-checkpoint-195
WANDB_NAME=$(echo $MODEL_PATH | rev | cut -d'/' -f1-3 | rev | tr '/' '-')
...
# export PYTHONPATH=/root/muze/VAGEN/verl:$PYTHONPATH
# export HIP_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
...
python3 -m vagen.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.limit_mm_per_prompt=5 \
    ...
    critic.model.path=/data/muze/models/Qwen2.5-VL-3B-Instruct \
    ...
    trainer.project_name='grpo_freethink' \
